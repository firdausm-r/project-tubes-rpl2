...
<div class="section py-5">
    <div class="container">
        <h3 class="text-center"><b>Kategori Topik</b></h3>
        <hr>
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12 col-sm-12 mb-3">
                <div class="input-group input-group-lg" id="search-field">
                    <input type="search" class="form-control form-control-lg  rounded-pill" aria-label="Search Category Field" id="search" placeholder="Cari Kategori Disini">
