...
<section class="py-3">
    <div class="container">
                ...
                <a href="./?p=posts/view_post&id=<?= $row['id'] ?>" class="card rounded-0 shadow text-decoration-none text-reset">
                    <div class="card-body">
                        <div class="mb-2 text-right">
                            ...
                            <?php if($row['status'] == 1): ?>
                                <small class="badge badge-light border text-dark rounded-pill px-3"><i class="fa fa-circle text-primary"></i> Sudah Dipublikasi</small>
                            <?php else: ?>
                                <small class="badge badge-light border text-dark rounded-pill px-3"><i class="fa fa-circle text-secondary"></i> Belum Dipublikasi</small>
                            <?php endif; ?>
                        </div>
        ...
        <?php if($posts->num_rows <= 0): ?>
            <h4 class="text-muted text-center"><i>Anda Belum Melakukan Posting Apapun</i></h4>
        <?php endif; ?>
    </div>
</section>
<script>
