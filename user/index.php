	...
	<div class="container">
		<div class="card card-outline rounded-0 card-navy">
			<div class="card-header">
				<h4 class="font-weight-bolder">Ubah Detail User</h4>
			</div>
			<div class="card-body">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<div class="custom-file">
										...
										<label class="custom-file-label rounded-0" for="customFile">Pilih file gambar</label>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary btn-sm btn-flat" form="manage-user">Ubah</button>
			</div>
		</div>
	</div>
</section>
