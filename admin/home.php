<h1>Selamat Datang, <?php echo $_settings->userdata('firstname')." ".$_settings->userdata('lastname') ?>!</h1>
<hr>
<div class="row">
  <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Daftar Kategori</span>
    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">User Yang Terdaftar</span>
          <span class="info-box-number">
            <?php 						
    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Post Yang Dipublikasikan</span>
          <span class="info-box-number">
            <?php 
    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Post Yang Tidak Dipublikasikan</span>
          <span class="info-box-number">
            <?php 
